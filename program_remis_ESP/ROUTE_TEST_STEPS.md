...
float a =
sin(dLat / 2) _ sin(dLat / 2) +
cos(radians(lat1)) _ cos(radians(lat2)) _
sin(dLon / 2) _ sin(dLon / 2);

float c = 2 _ atan2(sqrt(a), sqrt(1 - a));
return R _ c;
}
...
speedFiltered = (speedFiltered _ 0.8) + (gpsSpeed _ 0.2);
}
